   // Aktualny rok w stopce
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const destination = encodeURIComponent('Sanowa 15, 37-415 Zbydniów');
      const fallback = 'https://www.google.com/maps/dir//Sanowa+15,+37-415+Zbydni%C3%B3w/@50.6437313,21.924531,17z';
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const openViewer = (imgArray, label, startIndex = 0) => {
        if (!viewer) return;
        images = imgArray.length ? imgArray.slice() : ['images/przyklady_zlomu/placeholder.jpg'];
